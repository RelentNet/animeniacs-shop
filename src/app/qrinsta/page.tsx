...
/**
 * QR/short-link landing for Instagram. Renders a real 200 page (no 404 flash)
 * with a visible fallback link, and redirects on top via three layers so it
 * fires no matter what: JS `location.replace`, a `<meta refresh>` for no-JS, and
 * the tappable link if both are blocked.
 */
